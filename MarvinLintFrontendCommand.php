...
use Drupal\marvin_frontend_product\Lint\CommandEvent as LintFrontendCommandEvent;
...
final class MarvinLintFrontendCommand extends Command implements
  ...
  ContainerAwareInterface
{
  ...
  public const string NAME = 'marvin:lint:frontend';
  ...
  public function __construct(
    ...
    $this->eventDispatcher->addListener(
      LintFrontendCommandEvent::EVENT_RUN_TASKS_COLLECT,
      $this->onEventMarvinLintFrontendCollectTasks(...),
    );
  ...
  protected function execute(
    ...
    $event = $this->eventDispatcher->dispatch(
      ...
      LintFrontendCommandEvent::EVENT_RUN_TASKS_ALTER,
    );
  ...
  public function onEventMarvinLintFrontendCollectTasks(LintFrontendCommandEvent $event): void {
